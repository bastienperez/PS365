    ...
    param (
        ...
        switch ($true) {
            { $menu.DiscoveryItems -contains 'MSOnline' -or $MSOnline } {
                Write-Verbose "Gathering Internal Domains Matching Microsoft Entra ID Service Principal Names"
            ...
            { $menu.DiscoveryItems -contains 'ExchangeOnline' -or $ExchangeOnline } {
                ...
                $OnePerExoEmail = [System.Collections.Generic.List[PSCustomObject]]::New()
                ...
                $OnePerAllEmail = [System.Collections.Generic.List[PSCustomObject]]::New()
                ...
                # $AllEmails = [System.Collections.Generic.List[PSCustomObject]]::New()

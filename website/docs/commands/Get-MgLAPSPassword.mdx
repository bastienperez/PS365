---
description: Retrieves the LAPS password for a Microsoft Entra ID device.
...
```powershell
Get-MgLAPSPassword [-DeviceName <string>] [-DeviceID <string>] [-ShowPassword]
 [-IncludeHistory] [-RunFromAzureAutomation]
```

### KeyVault

```powershell
Get-MgLAPSPassword -BackupToKeyVault -KeyVaultName <string>
 [-DeviceName <string>] [-DeviceID <string>] [-ShowPassword] [-IncludeHistory]

---
description: Retrieves dynamic groups from Microsoft 365, Exchange Online, and Entra ID with attribute analysis.
...
```powershell
Get-DynamicGroup [[-GroupId] <string>] [-ExchangeOnlineOnly] [-EntraIDOnly]
 [-ExportToExcel] [-ExportPath <string>] [-IncludeMembers] [-MemberReport]

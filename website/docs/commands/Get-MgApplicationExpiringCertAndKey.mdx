...
```powershell
Get-MgApplicationExpiringCertAndKey [[-DaysUntilExpiry] <Int32>] [-ForceNewToken] [-ExportToExcel]
 [[-ExportPath] <String>] [-UseBatchRequest] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

---
description: Retrieves Entra ID applications with expiring credentials or SAML certificates.
...
```powershell
Get-MgApplicationExpiringCertAndKey [[-DaysUntilExpiry] <int>]
 [[-ExportPath] <string>] [-ForceNewToken] [-ExportToExcel] [-UseBatchRequest]
```

---
description: Retrieves the owners of all or a specific Entra ID group.
...
```powershell
Get-MgGroupOwnerInfo [[-GroupId] <string>] [[-DisplayName] <string>]
 [[-ExportPath] <string>] [-ExportToExcel]
```

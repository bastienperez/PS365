---
description: Tests whether delegates with calendar folder permissions still exist.
document type: cmdlet
HelpUri: https://ps365.clidsys.com/docs/commands/Test-ExCalendarPermission
Locale: en-US
Module Name: PS365
ms.date: 09/07/2026

...
id: Get-ExMailboxStatisticsInfo
title: Get-ExMailboxStatisticsInfo
hide_title: false
hide_table_of_contents: false
custom_edit_url: https://github.com/bastienperez/ps365/blob/main/powershell/public/Get-ExMailboxStatisticsInfo.ps1
---
...
```powershell
Get-ExMailboxStatisticsInfo [-Identity] <String> [-IncludeFolderDetails] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

---
description: Get Microsoft Entra ID Audit Log Sign-In Details
...
```powershell
Get-MgAuditLogSigninInfo [[-StartDate] <Object>] [[-EndDate] <Object>]
 [[-Users] <string[]>] [[-LastXSignIns] <int>] [[-IPAddresses] <int>]
 [[-ConditionalAccessPolicyName] <string>] [[-TimeRange] <string>]
 [-BasicAuthenticationOnly] [-SuccessOnly] [-FailureOnly] [-BadCredentialsOnly]
 [-LastLogonOnly] [-NonMFASignInsOnly] [-MFASignInsOnly]
 ...
 [-ConditionalAccessPolicySuccessOnly] [-ConditionalAccessPolicyFailedOnly]
 [-UseDatePicker] [-ForceNewToken] [-AnalyzeCAPInReportOnly] [-ExportToExcel]
```

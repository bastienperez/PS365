...
custom_edit_url: https://github.com/bastienperez/ps365/blob/main/powershell/public/Get-ExMailboxPermission.ps1
---
...
```powershell
Get-ExMailboxPermission [[-Identity] <String>] [-ByDomain <String>] [-UserPermissions <String>]

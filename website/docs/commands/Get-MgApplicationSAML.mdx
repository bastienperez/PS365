...
Get-MgApplicationSAML [-ForceNewToken] [-ExportToExcel] [-ExportPath <string>]
 [-RunFromAzureAutomation] [-ExpirationThresholdDays <int>]
 [-NotificationRecipient <string>] [-NotificationSender <string>]
 [-IncludeSignInStats] [-DisableParallel] [-ThrottleLimit <int>]
 [-UseBatchRequest]
```
...
```powershell
Get-MgApplicationSAML [-ObjectID <string>] [-ForceNewToken] [-ExportToExcel]
 [-ExportPath <string>] [-RunFromAzureAutomation]
 [-ExpirationThresholdDays <int>] [-NotificationRecipient <string>]
 [-NotificationSender <string>] [-IncludeSignInStats] [-DisableParallel]

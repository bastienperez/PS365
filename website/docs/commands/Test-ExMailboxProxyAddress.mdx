---
description: Test if a given proxy address exists in the proxy addresses of a mailbox.
...
```powershell
Test-ExMailboxProxyAddress [-Mailbox <string>] [-ProxyAddress <string>]
 [-MatchOnly] [-NotMatchOnly]
```

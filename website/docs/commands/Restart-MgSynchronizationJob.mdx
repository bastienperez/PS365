---
description: Restarts synchronization jobs for one or more Entra ID applications.
document type: cmdlet
HelpUri: https://ps365.clidsys.com/docs/commands/Restart-MgSynchronizationJob
Locale: en-US
Module Name: PS365
ms.date: 09/07/2026
...
```powershell
Restart-MgSynchronizationJob -DisplayName <string> [-ForceNewToken]
 [-RunFromAzureAutomation] [-ResetScope <string>] [-WhatIf] [-Confirm]
```

### ByObjectId

```powershell
Restart-MgSynchronizationJob -ObjectID <string> [-ForceNewToken]
 [-RunFromAzureAutomation] [-ResetScope <string>] [-WhatIf] [-Confirm]
```

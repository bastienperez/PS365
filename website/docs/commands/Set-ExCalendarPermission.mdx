---
description: Sets calendar folder permissions for a mailbox in Exchange Online.
document type: cmdlet
HelpUri: https://ps365.clidsys.com/docs/commands/Set-ExCalendarPermission
Locale: en-US
Module Name: PS365
ms.date: 09/08/2026
...
```powershell
Set-ExCalendarPermission [[-Identity] <string[]>] -AccessRights <string>
 -DelegateUser <string> [-WhatIf] [-Confirm]
```

### AllMailboxes

```powershell
Set-ExCalendarPermission -AllMailboxes -AccessRights <string> -DelegateUser

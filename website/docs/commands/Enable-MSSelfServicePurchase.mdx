...
```powershell
Enable-MSSelfServicePurchase [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Enables self-service purchase for all products in the Microsoft 365 tenant.

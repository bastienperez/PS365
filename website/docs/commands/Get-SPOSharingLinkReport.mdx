...
```powershell
Get-SPOSharingLinkReport [-SiteUrl] <string[]> -ClientId <string> -Tenant
 <string> [-CertificateThumbprint <string>] [-CertificatePath <string>]
 [-CertificatePassword <securestring>] [-CertificateBase64Encoded <string>]
 [-IncludeGraphDetails] [-LinkType <string[]>] [-ExpiredOnly]
 [-NeverExpiringOnly] [-ExpiringInDays <int>] [-ThrottleLimit <int>]

---
description: Retrieves the Service Connection Point (SCP) for Entra ID Hybrid Join from Active Directory.
document type: cmdlet
HelpUri: https://ps365.clidsys.com/docs/commands/Get-EntraIDHybridJoinSCP
Locale: en-US
Module Name: PS365
ms.date: 09/07/2026
sidebarTitle: Get-EntraIDHybridJoinSCP
title: Get-EntraIDHybridJoinSCP
---

...
```
Get-MgApplicationSCIM [-ExcludeAttributeMappings] [-IncludeFailedObjects] [-ForceNewToken]
...
```
Get-MgApplicationSCIM [-ObjectID <string>] [-ExcludeAttributeMappings] [-IncludeFailedObjects]
 ...
 [-ThrottleLimit <int>] [-UseBatchRequest] [-EntraCloudSync]
```

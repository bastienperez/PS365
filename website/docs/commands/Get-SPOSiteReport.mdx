...
Get-SPOSiteReport [-ClientId] <String> [-Tenant] <String> [[-CertificateThumbprint] <String>]
 ...
 [-IncludeAllDetails] [-IncludeSiteAdmins] [-IncludeSiteMembers] [-IncludeSiteVisitors] [-IncludeSharingLinks]
 [-IncludeSharingLinksDetails] [-RegionalSettingsDetails] [-M365GroupsDetails] [[-ThrottleLimit] <Int32>]
 [-ExportToExcel] [[-ExcelTemplatePath] <String>] [[-ExportPath] <String>] [-ExportToHtml] [-MultiGeoStats]

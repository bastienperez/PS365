...
```powershell
Set-ExMailboxProtocol [[-Identity] <string[]>] [-GenerateCmdlets]
 [-OutputFile <string>] [-ModernProtocolsOnly] [-ModernProtocolsAndEws]
 [-MAPIEnabled <bool>] [-OWAEnabled <bool>] [-PopEnabled <bool>]
...
```powershell
Set-ExMailboxProtocol -ByDomain <string> [-GenerateCmdlets]
 [-OutputFile <string>] [-ModernProtocolsOnly] [-ModernProtocolsAndEws]
 [-MAPIEnabled <bool>] [-OWAEnabled <bool>] [-PopEnabled <bool>]
 [-ImapEnabled <bool>] [-ActiveSyncEnabled <bool>] [-EwsEnabled <bool>]
 [-SmtpClientAuthenticationDisabled <bool>] [-UniversalOutlookEnabled <bool>]
...
```powershell
Set-ExMailboxProtocol -FromCSV <string> [-GenerateCmdlets]
 [-OutputFile <string>] [-ModernProtocolsOnly] [-ModernProtocolsAndEws]
 [-MAPIEnabled <bool>] [-OWAEnabled <bool>] [-PopEnabled <bool>]
 [-ImapEnabled <bool>] [-ActiveSyncEnabled <bool>] [-EwsEnabled <bool>]
 [-SmtpClientAuthenticationDisabled <bool>] [-UniversalOutlookEnabled <bool>]
...
```powershell
Set-ExMailboxProtocol -AllMailboxes [-GenerateCmdlets] [-OutputFile <string>]
 [-ModernProtocolsOnly] [-ModernProtocolsAndEws] [-MAPIEnabled <bool>]
 [-OWAEnabled <bool>] [-PopEnabled <bool>] [-ImapEnabled <bool>]
 [-ActiveSyncEnabled <bool>] [-EwsEnabled <bool>]
 [-SmtpClientAuthenticationDisabled <bool>] [-UniversalOutlookEnabled <bool>]
 [-OutlookMobileEnabled <bool>] [-WhatIf] [-Confirm]
```

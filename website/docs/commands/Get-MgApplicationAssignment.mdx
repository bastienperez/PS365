...
```powershell
Get-MgApplicationAssignment [-AllApplications] [-AssignmentNotEnforced]
...
```powershell
Get-MgApplicationAssignment [[-ApplicationId] <string[]>]
 [-AssignmentNotEnforced] [-AssignmentEmpty] [-ExportToExcel]
 [-ExportPath <string>] [-DisableParallel] [-ThrottleLimit <int>]
 [-UseBatchRequest]
```
...
```powershell
Get-MgApplicationAssignment [-ObjectID <string>] [-AssignmentNotEnforced]
 [-AssignmentEmpty] [-ExportToExcel] [-ExportPath <string>] [-DisableParallel]
 [-ThrottleLimit <int>] [-UseBatchRequest]
```
...
```powershell
Get-MgApplicationAssignment [-DisplayName <string>] [-AssignmentNotEnforced]
 [-AssignmentEmpty] [-ExportToExcel] [-ExportPath <string>] [-DisableParallel]
 [-ThrottleLimit <int>] [-UseBatchRequest]
```

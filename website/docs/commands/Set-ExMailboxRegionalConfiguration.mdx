...
```powershell
Set-ExMailboxRegionalConfiguration [-Identity] <string[]> [-Language <string>]
 [-TimeZone <string>] [-DateFormat <string>] [-TimeFormat <string>]
 [-OnlyIfLanguageEmpty] [-GenerateCmdlets] [-OutputFile <string>] [-WhatIf]
 [-Confirm]
```
...
```powershell
Set-ExMailboxRegionalConfiguration -ByDomain <string> [-Language <string>]
 [-TimeZone <string>] [-DateFormat <string>] [-TimeFormat <string>]
 [-OnlyIfLanguageEmpty] [-GenerateCmdlets] [-OutputFile <string>] [-WhatIf]
 [-Confirm]
```
...
```powershell
Set-ExMailboxRegionalConfiguration -FromCSV <string> [-DateFormat <string>]
 [-TimeFormat <string>] [-OnlyIfLanguageEmpty] [-GenerateCmdlets]
...
```powershell
Set-ExMailboxRegionalConfiguration -AllMailboxes [-Language <string>]
 [-TimeZone <string>] [-DateFormat <string>] [-TimeFormat <string>]
 [-OnlyIfLanguageEmpty] [-GenerateCmdlets] [-OutputFile <string>] [-WhatIf]
 [-Confirm]
```

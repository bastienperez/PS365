---
description: Converts between Microsoft Entra ID SID and Object ID formats.
document type: cmdlet
HelpUri: https://ps365.clidsys.com/docs/commands/Convert-EntraObjectIDAndSID
Locale: en-US
Module Name: PS365
ms.date: 09/07/2026
sidebarTitle: Convert-EntraObjectIDAndSID
title: Convert-EntraObjectIDAndSID
---
...
```
Convert-EntraObjectIDAndSID [-Value] <string>
```
...
- SID (S-1-12-1-...) â†’ returns the corresponding Object ID (GUID)
- Object ID (GUID)   â†’ returns the corresponding SID (S-1-12-1-...)

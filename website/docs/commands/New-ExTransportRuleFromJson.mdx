---
description: Creates Exchange Online transport (mail flow) rules from one or more JSON definition files.
document type: cmdlet
HelpUri: https://ps365.clidsys.com/docs/commands/New-ExTransportRuleFromJson
Locale: en-US
Module Name: PS365
ms.date: 09/08/2026
sidebarTitle: New-ExTransportRuleFromJson
title: New-ExTransportRuleFromJson
---
...
```powershell
New-ExTransportRuleFromJson [-Path] <string[]> [-Force] [-GenerateCmdlets]

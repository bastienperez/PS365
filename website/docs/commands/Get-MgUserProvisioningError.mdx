---
description: Lists the users carrying provisioning errors in Microsoft Entra ID.
...
```powershell
Get-MgUserProvisioningError [[-Identity] <string>] [-ErrorSource <string>]
 [-IncludeResolved] [-ForceNewToken] [-ExportToExcel]
```

---
sidebarTitle: "Get-MgBitlockerKeyInfo"
document type: cmdlet
HelpUri: https://ps365.clidsys.com/docs/commands/Get-MgBitlockerKeyInfo
Locale: en-US
Module Name: PS365
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: "Get-MgBitlockerKeyInfo"
---
...
```powershell
Get-MgBitlockerKeyInfo [-IncludeDeviceInfo] [-IncludeDeviceOwner] [-ExportToExcel]
 [-ExportPath <string>] [-ShowKeyInPlainText] [-RunFromAzureAutomation] [-DeviceName <string>]
 [-DeviceID <string>]
```
...
```powershell
Get-MgBitlockerKeyInfo -BackupToKeyVault -KeyVaultName <string> [-IncludeDeviceInfo]
 [-IncludeDeviceOwner] [-ExportToExcel] [-ExportPath <string>] [-ShowKeyInPlainText]
 [-RunFromAzureAutomation] [-DeviceName <string>] [-DeviceID <string>]
```

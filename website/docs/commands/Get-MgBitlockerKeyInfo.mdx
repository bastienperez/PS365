...
Get-MgBitlockerKeyInfo [-IncludeDeviceInfo] [-IncludeDeviceOwner]
 [-ExportToExcel] [-ExportPath <string>] [-ShowKeyInPlainText]
...
```powershell
Get-MgBitlockerKeyInfo -BackupToKeyVault -KeyVaultName <string>
 [-IncludeDeviceInfo] [-IncludeDeviceOwner] [-ExportToExcel]
 [-ExportPath <string>] [-ShowKeyInPlainText] [-RunFromAzureAutomation]

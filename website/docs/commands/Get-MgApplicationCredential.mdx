...
```powershell
Get-MgApplicationCredential [-ExportToExcel] [-ExportPath <string>]
...
```powershell
Get-MgApplicationCredential [-ObjectID <string>] [-ExportToExcel]
 [-ExportPath <string>] [-ForceNewToken] [-RunFromAzureAutomation]
 [-ExpirationThresholdDays <int>] [-NotificationRecipient <string>]
...
```powershell
Get-MgApplicationCredential [-DisplayName <string>] [-ExportToExcel]
 [-ExportPath <string>] [-ForceNewToken] [-RunFromAzureAutomation]
 [-ExpirationThresholdDays <int>] [-NotificationRecipient <string>]
 [-NotificationSender <string>] [-DisableParallel] [-ThrottleLimit <int>]
 [-UseBatchRequest]

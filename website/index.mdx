---
title: "PS365 - PowerShell for Microsoft 365"
...
- Beta API integration for enhanced data

**Example:**
```powershell
# Get detailed authentication methods for all users
Get-MgAuthNMethodInfo -IncludeDetails -ExportToExcel

# Analyze specific users with last used information
Get-MgAuthNMethodInfo -Identity @('user1@contoso.com', 'user2@contoso.com') -IncludeLastUsedMethod
```

<#
    ...
    Generates the Set-CasMailbox cmdlets for all mailboxes in the specified domain to enable modern protocols only and saves them to the specified file without executing them.
    ...
    process {
        ...
        foreach ($casMailbox in $Mailboxes) {
            ...
            if ($GenerateCmdlets) {
                ...
                $command = 'Set-CasMailbox ' + (($cmdParams.GetEnumerator() | ForEach-Object {

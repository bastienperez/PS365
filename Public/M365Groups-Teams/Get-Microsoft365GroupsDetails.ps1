...
#>
	...
	foreach ($group in $groups) {
		...
		[System.Collections.Generic.List[PSCustomObject]]$channelsNames = @()
		[System.Collections.Generic.List[PSCustomObject]]$uGroupMembersEmail = @()
		[System.Collections.Generic.List[PSCustomObject]]$uGroupOwnersEmail = @()	
